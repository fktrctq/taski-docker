...
Собираем образы
В папках frontend/, backend/ и gateway/ соберите образы taski_frontend, taski_backend и taski_gateway образ nginx с конфигом для управления проектом Taski и отправьте их в Docker Hub.
За работу! В терминале в корне проекта Taski последовательно выполните команды из листинга; замените username на ваш логин на Docker Hub.
...
Проверьте, что на вашем компьютере созданы необходимые образы, — выполните команду docker image ls