...
ALLOWED_HOSTS = ['*']
# ALLOWED_HOSTS = ['localhost', '123.123.123.123', '<your_domain>']  # на проде определить с какого адреса доступен бэкенд
...
#         'NAME': '/data/db.sqlite3', # БД будет лежать в корне примонтированного docker volume
#     }
# }
